...
SECRET_KEY = 'django-insecure-l$p%48s4eq&+bi4k#(d+#wp^%k)+fg+s2(_xc(h&1uwaxdsd3!'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['waste-management-django.onrender.com']
...
ROOT_URLCONF = 'new_waste_management.urls'  # Updated to match project name
...
WSGI_APPLICATION = 'new_waste_management.wsgi.application'
